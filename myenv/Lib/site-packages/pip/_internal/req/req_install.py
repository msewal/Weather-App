...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # original_link is the direct URL that was provided by the username for the
        ...
        # by the username via CLI arguments or requirements files, as opposed to,
            ...
            if use_user_site:
                if existing_dist.in_usersite:
                    ...
                    raise InstallationError(
                        f"Will not install to the username site because it will "
