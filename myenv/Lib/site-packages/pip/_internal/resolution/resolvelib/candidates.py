...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def _prepare(self) -> BaseDistribution:
        try:
            ...
            # offending line to the username.
            e.req = self._ireq
            raise
...
class ExtrasCandidate(Candidate):
    ...
    def __init__(
        ...
        *,
        ...
        # the non-normalized extra for lookup ensures the username can select a
    ...
    def _calculate_valid_requested_extras(self) -> FrozenSet[str]:
        ...
        The username (or upstream dependant) may have specified extras that the
