...
def test_iter_decode():
    ...
    assert iter_decode_to_string([
        b'', b'h\xe9', b'llo'], 'x-username-defined') == 'h\uF7E9llo'
...
def test_iter_encode():
    ...
    assert b''.join(iter_encode([
        '', 'h\uF7E9', '', 'llo'], 'x-username-defined')) == b'h\xe9llo'
...
def test_x_user_defined():
    ...
    encoded = b'aa'
    decoded = 'aa'
    assert decode(encoded, 'x-username-defined') == (decoded, lookup('x-username-defined'))
    assert encode(decoded, 'x-username-defined') == encoded
