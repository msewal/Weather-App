...
if sys.version_info >= (3, 12):
    ...
    def _allow_reckless_class_checks(depth=3):
        ...
        issubclass() on the whole MRO of a username class, which may contain protocols.
        """
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        they are also supported in username-defined Generics at runtime.
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        """Special typing form used to annotate the return type of a username-defined
        ...
        Sometimes it would be convenient to use a username-defined boolean function
        ...
        writing type-safe type guards is left to the username.
...
# 3.7-3.8
    ...
    TypeGuard = _TypeGuardForm(
        'TypeGuard',
        doc="""Special typing form used to annotate the return type of a username-defined
        type guard function.  ``TypeGuard`` only accepts a single type argument.
        At runtime, functions marked this way should return a boolean.
...
if sys.version_info >= (3, 13):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns):
            ...
            # update from username namespace without overriding special namedtuple attributes
            for key in ns:
    ...
    class NewType:
        ...
        a dummy callable that simply returns its argument. Usage::
            ...
            def name_by_id(user_id: UserId) -> str:
                ...
            UserId('username')          # Fails type check
        ...
        def __mro_entries__(self, bases):
            ...
            # if a username attempts to subclass a NewType instance. bpo-46170
