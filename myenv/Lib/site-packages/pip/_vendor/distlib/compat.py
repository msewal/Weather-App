...
if sys.version_info[0] < 3:  # pragma: no cover
    ...
    # _userprog = None
    # def splituser(host):
    # """splituser('username[:passwd]@host[:port]') --> 'username[:passwd]', 'host[:port]'."""
    # global _userprog
...
try:
    ...
    # sys.getfilesystemencoding(): the return value is "the username’s preference
...
try:
    ...
    class BaseConfigurator(object):
        ...
        def configure_custom(self, config):
            """Configure an object with a username-supplied factory."""
            c = config.pop('()')
            if not callable(c):
                c = self.resolve(c)
